...
public class Pool
{
    ...
    public GameObject Pull(bool worldPos = false)
    {
        // Is there one ready?
    ...
    private GameObject AddItem(bool keepActive = false, bool worldPos = false)
    {
        ...
        {
            pool[index].transform.SetParent(parentingGroup, worldPos);
        }
        return pool[index];
    }
}